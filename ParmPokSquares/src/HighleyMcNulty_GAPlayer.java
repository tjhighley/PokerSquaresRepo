...
public class HighleyMcNulty_GAPlayer extends HighleyMcNulty_OurPlayer implements PokerSquaresPlayer {
     ...
     */
    public HighleyMcNulty_GAPlayer(int depthLimit, int popSize) {        
        this.depthLimit = depthLimit;
        this.popSize = popSize;
        this.numElites = popSize / 20;
    }
    
    public HighleyMcNulty_GAPlayer(int depthLimit, int popSize, int numMutations, boolean crossoverOn) {
