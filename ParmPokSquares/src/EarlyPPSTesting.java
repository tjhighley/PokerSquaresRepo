...
public class EarlyPPSTesting {
	...
	public static void main(String[] args) {
		...
		PokerSquaresPlayer player = new HighleyMcNulty_SRulerPlayer(0); // TODO - replace the RandomPlayer with your best player
		...
		for (PokerSquaresPointSystem system : systems) {
			...
			int[] scores = new PokerSquares(player, system).playSequence(5, 0L, true); // TODO - set verbose "true" to "false" to omit play-by-play details
			int total = 0;
